...
> the one place [`CLAUDE.md`](./CLAUDE.md) → Convention 3's "write in the present, delete the narration"
...
> Keep it to genuinely load-bearing decisions (see [`CLAUDE.md`](./CLAUDE.md) → Convention 8); if a
> choice doesn't earn its entry, leave it out. The *how it works* lives in the core pages — link to it,
> don't restate it here.

<Add one entry per decision, like the template below. Delete this line and the placeholder entry.>

### <YYYY-MM-DD> — <short decision title>

- **Chose:** <what you chose.>
- **Why:** <the reason it wins for this project.>
- **Rejected:** <the main alternative considered, and why not.>
- **Revisit if:** <what would invalidate this — omit if nothing obvious.>
- **Superseded by:** <later entry title — add only when this decision is reversed; omit otherwise.>
